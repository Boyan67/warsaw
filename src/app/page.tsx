  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        id: 'sat-museum',
        time: '14:30',
        title: 'Polish Vodka Museum',
        description: 'Located in a historic distillery. Includes a guided tour and tasting session.',
        locationQuery: 'Polish Vodka Museum, Plac Konesera, Warszawa',
      },
      {
        id: 'sat-cosmos',
        time: '16:00',
        title: 'Cosmos Museum',
        description: 'Interactive illusions and digital art. Great for photos.',
        locationQuery: 'Cosmos Museum Warsaw',
      },
      {
        id: 'sat-view',
        time: '18:00',
